...
public class Sekjar {
   ...
   // initial key permutation 64 => 56 byte
	...
	// key permutation at round i 56 => 48 byte
    ...
    public static byte[] encrypt(byte[] data, byte[] key) {
		...
		for (i = 0; i < data.length + lenght; i++) {
			if (i > 0 && i % 8 == 0) {
				bloc = encrypt64Bloc(bloc,K, false);//buat bagian bagi kanan kiri
    ...
    public static void main(String[] args) {
      try{
			String textClar = "coba";
			
			
			textClar = "bloidas is alive you little bitch";
			//DES
                            String k = "1434ABCD34352";
			System.out.println("input text: "+textClar);
			byte[] enc = encrypt(textClar.getBytes(), k.getBytes());
			System.out.println("hasil enkripsi: "+new String(enc));

			byte[] dec = decrypt(enc, k.getBytes());
			System.out.println("hasildekripsi: "+new String(dec));
			System.out.println("------------------");
